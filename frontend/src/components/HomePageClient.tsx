...
const MOCK_SPORTS: Sport[] = [
  ...
  { id: 2, name: 'Football turf & Training', slug: 'football-turf-training', description: 'Progressive soccer drills, technical training, and matches on our high-quality turf area for kids and youth.', schedule: 'Wed, Fri, Sat: 4:30 PM - 6:30 PM', image: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&q=80&w=800', order: 2 },
